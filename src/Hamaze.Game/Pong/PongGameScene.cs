...
public class PongGameScene : Scene
{
  public override void Initialize()
  {
    ...
    paddle1.Position = new(32, Viewport.ScreenSize.Y / 2 - AIPaddle.Size.Y / 2);
    ...
    paddle1.SetCollider(new Collider(Vector2.Zero, AIPaddle.Size));
    world.AddChild(paddle1);


    Entity paddle2 = new();
    AIPaddle aIPaddle2 = new();
    paddle2.Position = new(Viewport.ScreenSize.X - 32 - AIPaddle.Size.X, Viewport.ScreenSize.Y / 2 - AIPaddle.Size.Y / 2);
    paddle2.AddComponent(new PaddleSprite());
    paddle2.AddComponent(aIPaddle2);
    paddle2.AddSystem(new AIPaddleSystem());
    paddle2.SetCollider(new Collider(Vector2.Zero, AIPaddle.Size));
    ...
    world.AddSystem(new PongCollisionSystem());
